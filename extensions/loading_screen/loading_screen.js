...
// Fecha de creaci�n:			13/06/2015
// Autor:						Momfus Arboleo (modifiaci�n del creado por FMS)
// Proyecto:					HTML5
// Descripci�n:					Barra de carga personalizable
// ----------------------------------------------------------------------------------------------------------------------
// 13/06/2015		V1.0		Momfus
//
// ----------------------------------------------------------------------------------------------------------------------
//	Nota 1: Este archivo est� basado en el creador por FMS pero adaptandolo a las necesidades y en espa�ol, se explica muchas cosas
//
//  Nota 2: Las variables o par�metros que empiezan con gui�n bajo indican variables que vienen de GMS
//
// **********************************************************************************************************************
...
function custom_loading_screen(_graphics, _width, _height, _total, _current, _loadingscreen) {
	...
	//////////////////////  CONFIGURACI�N DEL TEXTO //////////////////////
			...
			var text_y_pos= (_height/2) ;									//Posici�n vertical del texto: usado (_height/2) para el medio

	/////////////////////  CONFIGURACI�N DE LA BARRA DE CARGA ////////////////////////////////

			var barwidth = (_width * 0.3) ;					// El ancho que tendr� en pixeles, en este caso se busca que sea el 70% del ancho de pantalla
			var barheight = 25;                          	// El alto en pixeles
			var x = 32 + (_width - barwidth) / 2;//(_width - barwidth) / 2;				// La posicion horizontal de la barra
			var y = 400//170 + (_height - barheight) / 2;		// La posici�n vertical de la barra
			var w = (barwidth / _total) * _current;         // Variable usada para calcular el ancho mientras se carga el juego NO MODIFICAR
			var border = 2   								// Borde de la barra en pixeles (contorno)
	...
	///////////////////// CONFIGURACI�N DEL FONDO (si no hay imagen)  ///////////////////////////////////
			...
			var ls_y_pos = 0;   						// Posici�n vertical de donde se muestra el fondo
			var ls_x_pos = 0;  							// Idem que arriba pero la horizontal

	// #############################################################################################
	// Funci�n: Sirve para centrar algo de texto
	...
	/* SI el ""splashscreen" de GM est� seteado para usarse, y est� con el mismo ancho y alto que el
	...
	// Se dibuja la barra s�lamente si hay algo cargado del archivo
	if (_current != 0){
